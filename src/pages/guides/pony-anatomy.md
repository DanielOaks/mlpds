...
The <router-link to="/guides/chumpy/5-common-anatomy-errors">Common Anatomy Errors guide</router-link> includes a lot of miscellaneous info on parts of the pony that is super useful for getting all the proportions right.
